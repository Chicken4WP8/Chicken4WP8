...
{
    public class CustomerOAuthController : IOAuthController
    {
        private OAuth.OAuthSession session;

        public CustomerOAuthController()
        { }
        ...
        public async Task<OAuthSetting> GetTokensAsync(string pinCode)
        {
            ...
            return new CustomerOAuthSetting
            {
                ConsumerKey = session.ConsumerKey,
                ConsumerSecret = session.ConsumerSecret,
        ...
        {
            var oauth = setting as CustomerOAuthSetting;
