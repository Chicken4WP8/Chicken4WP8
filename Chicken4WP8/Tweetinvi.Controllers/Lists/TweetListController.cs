...
namespace Tweetinvi.Controllers.Lists
{
    public class TweetListController : ITweetListController
    {
        ...
        public IEnumerable<ITweetList> GetUserLists(IUserIdentifier userDTO, bool getOwnedListsFirst)
        {
        ...
        public ITweetList UpdateList(string slug, IUserIdentifier ownerDTO, IListUpdateParameters parameters)
        {
        ...
        public bool DestroyList(string slug, IUserIdentifier ownerDTO)
        {
            var identifier = _listIdentifierFactory.Create(slug, ownerDTO);
            return DestroyList(identifier);
        }
        ...
        public IEnumerable<ITweet> GetTweetsFromList(string slug, IUserIdentifier ownerDTO)
        {
            var identifier = _listIdentifierFactory.Create(slug, ownerDTO);
            return GetTweetsFromList(identifier);
        }
        ...
        public IEnumerable<IUser> GetMembersOfList(string slug, IUserIdentifier ownerDTO, int maxNumberOfUsersToRetrieve = 100)
        {
            var identifier = _listIdentifierFactory.Create(slug, ownerDTO);
            return GetMembersOfList(identifier, maxNumberOfUsersToRetrieve);
        }
