...
using Tweetinvi.Controllers.Lists;
...
namespace Tweetinvi.Controllers
{
    public class TweetinviControllersModule : ITweetinviModule
    {
        ...
        private void InitializeControllers()
        {
            ...
            _container.RegisterType<ITweetListController, TweetListController>(RegistrationLifetime.InstancePerThread);
        ...
        private void InitializeJsonControllers()
        {
            ...
            _container.RegisterType<ITweetListJsonController, TweetListJsonController>(RegistrationLifetime.InstancePerThread);
        ...
        private void InitializeQueryExecutors()
        {
            ...
            _container.RegisterType<ITweetListQueryExecutor, TweetListQueryExecutor>();
        ...
        private void InitializeQueryGenerators()
        {
            ...
            _container.RegisterType<ITweetListQueryGenerator, TweetListQueryGenerator>();
            
            _container.RegisterType<IQueryParameterGenerator, QueryParameterGenerator>();
            _container.RegisterType<ITweetListQueryParameterGenerator, TweetListQueryParameterGenerator>();
        ...
        private void InitializeQueryValidators()
        {
            ...
            _container.RegisterType<ITweetListQueryValidator, TweetListQueryValidator>();
        }
