...
namespace Tweetinvi.Streams
{
    ...
    {
        protected string _filterLanguage;
        ...
        public void FilterTweetsToBeIn(string language)
        {
            _filterLanguage = language;
        }

        public void FilterTweetsToBeIn(Language language)
        {
            _filterLanguage = language.GetDescriptionAttribute();
        }
