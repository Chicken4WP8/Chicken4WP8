...
namespace Tweetinvi.Logic
{
    ...
    public class Tweet : ITweet
    {
        ...
        public int Length
        {
            get { return _tweetDTO.Text == null ? 0 : StringExtension.TweetLength(_tweetDTO.Text); }
        }
        ...
        {
            return MAX_TWEET_SIZE - StringExtension.TweetLength(Text);
        }
        ...
        {
            if (replyToTweet == null || replyToTweet.Id == TweetinviConfig.DEFAULT_ID)
            {
                return false;
            }
        ...
        {
            return _tweetDTO != null && _tweetDTO.Id != TweetinviConfig.DEFAULT_ID && IsTweetPublished && !IsTweetDestroyed;
        }
